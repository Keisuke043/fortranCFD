...
def spHRRpTrhou(save_dir, ev_num=1):
    ...
    for i, df in data_nout_dict.items():
        ...
        ax[0].legend(handler_0o+handler_0t, label_0o+label_0t, loc='upper left', 
                     bbox_to_anchor=(0.0, 1.25,), borderaxespad=0, ncol=8, fontsize=12)
...
if __name__ == "__main__":
    ...
    sp_list = ['nC7H16', 'nC7KET', 'O2', 'CH2O', 'CO', 'CO2', 'H2O']
