...
if __name__ == "__main__":
    ...
    read_dir_name = './RESULTS_sph_flame_TH2000_hdf'
    read_dir_name = './RESULTS_sph_flame_TH1820_hdf'
    read_dir_name = './RESULTS_sph_flame_TH1810_hdf'
    read_dir_name = './RESULTS_sph_flame_TH1600_hdf'
    ...
    sp_list = ['CH4', 'O2', 'CH2O', 'CO', 'CO2', 'H2O']
